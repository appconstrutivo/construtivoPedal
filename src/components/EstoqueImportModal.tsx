      ...
      <div className="st-modal st-modal--lg">
        ...
        <form className="st-form" onSubmit={(e) => void handleSubmit(e)}>
          <p className="st-pricing-hint">
            ...
            <strong>Nome</strong>, <strong>Preço de Venda</strong> (custo) e <strong>Quantidade</strong>.
          ...
          <div className="st-form-grid">
            ...
            <label className="st-field">
              ...
              <input
                ...
                disabled={importando}
              />
              <p className="st-field__hint">Preço varejo/atacado = custo + markup.</p>
            </label>
          </div>
          <label className="st-field">
                      ...
                      <tr key={`${linha.linhaPlanilha}-${linha.skuFornecedor}`}>
                        ...
                        <td>
                          {formatBRL(
                            calcularPrecoComMarkup(
                              linha.custo,
                              Number.isFinite(markupNumero) ? markupNumero : 0,
                            ),
                          )}
                        </td>
                      </tr>
          ...
          {resultado && (
            <div className="st-import-resultado" role="status">
              <p>
                ...
                atualizado(s) (mesmo nome e fornecedor).
              </p>
